				...
				<q-card-section style="max-height: 50vh" class="scroll">
					<div class="row">
						<q-input
							...
							label="Description"
						/>
						<q-checkbox v-model="form.Cases" label="Cases" :true-value="1" :false-value="0" />
	...
	export default {
		data() {
			return {
				...
				columns: [
					...
					{ name: 'Cases', label: 'Cases', field: 'Cases', sortable: true, align: 'left' },
					{
						name: 'Status',
						label: 'Status',
						field: 'Status',
				...
				//vcolumns: ['Cases', 'Description', 'Status'],
				data: [],
				loading: false,
				filter: '',
				rowCount: 10,
		...
		methods: {
			...
			openEditDialog(row) {
				...
				this.form.Cases = this.form.Cases ? 1 : 0
